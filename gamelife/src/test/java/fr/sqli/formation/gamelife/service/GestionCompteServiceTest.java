...
class GestionCompteServiceTest {
    ...
    void testModificationCompte01() throws Exception {
        ...
        UtilisateurEntite test = service.modificationCompte(dto);
        Assertions.assertEquals("Ballancourt",test.getVille());
    }
    @Test
    void testModificationCompte02() throws Exception {
        GestionCompteDto dto = new GestionCompteDto(UUID.randomUUID(), "acheteur", "acheteur", "acheteur@gamelife.fr", 2, "rue du marechal", "nantes", 44000, null);
    ...
    void testModificationMdp01() throws Exception {
        ...
        UtilisateurEntite test = service.modificationMdp(dto);
...
@Test
    ...
    UtilisateurEntite test = service.modificationEtat(dto);
