...
public class GestionCompteControler {
    ...
    public ResponseEntity inscr01(@RequestBody GestionCompteDto monbody) throws Exception{
        ...
        res = service.modificationCompte(monbody.getNom(), monbody.getPrenom(), monbody.getNew_email(), monbody.getOld_email(), monbody.getVille(), monbody.getNum_rue(), monbody.getRue(), monbody.getRole(), monbody.getNum_siren(), monbody.getEtat());
