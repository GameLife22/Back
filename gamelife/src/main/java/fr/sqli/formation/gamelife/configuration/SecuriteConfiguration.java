    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize.requestMatchers(new AntPathRequestMatcher(h2Url + "/**") // h2
                    ...
                    header.frameOptions(HeadersConfigurer.FrameOptionsConfig::disable);
                        ...
                        .antMatchers("/api/v1/produits").permitAll()
                        .antMatchers("/api/v1/produits/{produitId}").permitAll()
                        .antMatchers("/api/v1/produits/disable/{produitId}").permitAll()
                        .antMatchers("/api/v1/plateformes").permitAll()
                        .antMatchers("/api/v1/plateformes/{produitId}").permitAll()
                        .antMatchers("/api/v1/categories").permitAll()
                        .antMatchers("/api/v1/categories/{produitId}").permitAll()
