    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize.requestMatchers(new AntPathRequestMatcher(h2Url + "/**") // h2
                    ...
                    header.frameOptions(HeadersConfigurer.FrameOptionsConfig::disable);
                        ...
                        .antMatchers("/api/plateformes").hasAnyRole(ROLE_ADMIN, ROLE_MODERATEUR)
                        .antMatchers("/api/plateformes/{produitId}").hasAnyRole(ROLE_ADMIN, ROLE_MODERATEUR)
                        .antMatchers("/api/categories").hasAnyRole(ROLE_ADMIN, ROLE_MODERATEUR)
                        .antMatchers("/api/categories/{produitId}").hasAnyRole(ROLE_ADMIN, ROLE_MODERATEUR)
