package fr.sqli.formation.gamelife.utilitaire;
...
public final class ValidationUtilitaire {

    private ValidationUtilitaire() {
    ...
    public static <T, R> void modifierEntityIfDtoDiffers(T pEntity, R pDto) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
