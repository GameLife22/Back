...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/games/genres").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/games/platforms").permitAll()
                .requestMatchers(HttpMethod.GET,API_V1_GAMES_ID).permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/games").hasAnyAuthority(ADMIN,SELLER)
