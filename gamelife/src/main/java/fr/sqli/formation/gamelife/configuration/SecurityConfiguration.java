...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET,"/api/v1/games/{gameId}").hasAnyAuthority(ADMIN, SELLER)
                .requestMatchers(HttpMethod.POST, "/api/v1/games").hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.PATCH,"/api/v1/games/{gameId}").hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.DELETE,"/api/v1/games").hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.DELETE,"/api/v1/games/{gameId}").hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.GET,"/api/v1/games/genres").hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.GET,"/api/v1/games/platforms").hasAuthority(ADMIN)
