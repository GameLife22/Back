...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/commande/all").hasAnyAuthority(ADMIN ,BUYER)
                .requestMatchers("/commande/creer").hasAnyAuthority(ADMIN ,BUYER)
                .requestMatchers("/commande/{idCommande}").hasAnyAuthority(ADMIN ,BUYER)
                .requestMatchers("/commande/{idCommande}/modif-quantite").hasAnyAuthority(ADMIN ,BUYER)
                .requestMatchers("/commande/{idCommande}/prix-total").hasAnyAuthority(ADMIN ,BUYER)
                .requestMatchers("/commande/{idCommande}/ajout-produit").hasAnyAuthority(ADMIN ,BUYER)
                .requestMatchers(HttpMethod.PUT,"/commande/{idCommande}/valider-commande").hasAnyAuthority(ADMIN ,BUYER)
                .requestMatchers("/commande/{idCommande}/supp-article/{idProduit}").hasAnyAuthority(ADMIN ,BUYER)
