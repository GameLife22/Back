...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/games").permitAll()//.hasAnyAuthority(ADMIN, SELLER)
                .requestMatchers(HttpMethod.GET, "/api/v1/games/genres").permitAll()//.hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.GET, "/api/v1/games/platforms").permitAll()//.hasAuthority(ADMIN)
