...
public class InscriptionDto {
    ...
    public InscriptionDto(String email, String etat, String mdp, String nom, int num_rue, String num_siret, String prenom, String role, String rue, String ville, int code_postal) {
        this.email = email;
        this.etat = etat;
        this.mdp = mdp;
        this.nom = nom;
