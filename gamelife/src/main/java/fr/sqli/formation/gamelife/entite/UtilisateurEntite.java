...
public class UtilisateurEntite {
    ...
    private List<CommandeEntite> commandes = new ArrayList<>();
    ...
    public UtilisateurEntite(String pNom, String pPrenom, String pMdp, String pEmail, Integer pNumRue, String pRue, String pVille, Integer pCodePostal, String pRole, String pNumSiren, Boolean pEtatCompte, String pResetPasswordToken) {
        nom = pNom;
        prenom = pPrenom;
        mdp = pMdp;
        email = pEmail;
    ...
    public UtilisateurEntite(UUID pUtilisateurId) {
    }
    ...
    public List<CommandeEntite> getCommandes() {
        return commandes;
    }

    public void setCommandes(List<CommandeEntite> commandes) {
